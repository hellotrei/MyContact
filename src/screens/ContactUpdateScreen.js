...
import {Colors, Container, Spacing, Typography} from '../components/styles';
import Utils from '../utils';

export default function ContactUpdateScreen({navigation, route}) {
  ...
  return (
    <View style={styles.ContactUpdateScreen}>
      <HeaderBar
        isLoading={isLoading}
        loadingMessage={
          actionStatus === 'EDIT'
...
const styles = StyleSheet.create({
  ...
  textInput: {
    ...Typography.baseText,
    ...Container.textInputBottomBorder,
